...
const sharedProjects = [
  { number:'01', title:'AFM Explorer', stack:'Python · FastAPI · MCP · Agents SDK · RAG · AWS', image:'/projects/afm-curve-analysis.png', repo:'https://github.com/KashishMendiratta/afm-explorer', live:'https://afm.kashishmendiratta.com', accent:'cyan' },
...
const copy = {
  en: {
    ...
    projects:[
      ['Deployed agentic ML platform','A full-stack force-spectroscopy platform with a built-in interactive demo, FastAPI and Streamlit applications, authenticated MCP tools, and a bounded autonomous agent that combines live scan data with local RAG. Deployed with Docker and automated delivery to AWS.',['Live demo','52 tests','MCP + RAG agent'],'AFM force curve with an automatically detected contact point'],
  ...
  de: {
    ...
    projects:[
      ['Deployte agentische ML-Plattform','Eine Full-Stack-Plattform für Kraftspektroskopie mit integriertem interaktivem Demo, FastAPI- und Streamlit-Anwendungen, authentifizierten MCP-Tools sowie einem begrenzten autonomen Agenten, der Live-Scandaten mit lokalem RAG verbindet. Deployment mit Docker und automatisierter Bereitstellung auf AWS.',['Live-Demo','52 Tests','MCP + RAG Agent'],'AFM-Kraftkurve mit automatisch erkanntem Kontaktpunkt'],
